        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/contacto" className="text-slate-400 hover:text-devin-teal hover:underline transition-colors text-sm cursor-pointer">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <a href="https://www.instagram.com/transparentreasons/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 shrink-0 rounded-full bg-devin-surface border border-devin-border flex items-center justify-center text-slate-400 hover:text-devin-teal hover:border-devin-teal transition-all">
                <Instagram size={18} />
              </a>
              <a href="https://www.facebook.com/transparentreasons" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 shrink-0 rounded-full bg-devin-surface border border-devin-border flex items-center justify-center text-slate-400 hover:text-devin-teal hover:border-devin-teal transition-all">
                <Facebook size={18} />
              </a>
              <a href="mailto:geral@transparentreasons.com" aria-label="Email" className="w-10 h-10 shrink-0 rounded-full bg-devin-surface border border-devin-border flex items-center justify-center text-slate-400 hover:text-devin-teal hover:border-devin-teal transition-all">
                <Mail size={18} />
              </a>
              <a href="tel:+351930679484" aria-label="Telefone" className="w-10 h-10 shrink-0 rounded-full bg-devin-surface border border-devin-border flex items-center justify-center text-slate-400 hover:text-devin-teal hover:border-devin-teal transition-all">
                <Phone size={18} />
              </a>
              <a href="https://wa.me/351930679484" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 shrink-0 rounded-full bg-devin-surface border border-devin-border flex items-center justify-center text-slate-400 hover:text-green-400 hover:border-green-400/50 transition-all">
