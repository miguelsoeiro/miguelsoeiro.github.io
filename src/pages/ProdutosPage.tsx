  ...
  return (
    <PageLayout>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* ── Secção 1: Tecnologia & Ferramentas ── */}
        <div className="mb-20">
          <div className="mb-10">
            <SectionBadge label="Tecnologia & Ferramentas" />
          ...
          <div className="mt-8 flex justify-end">
            <Link
              to="/produtos/tecnologia-ferramentas"
              className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-devin-teal transition-colors"
            >
              Ver preços e serviços de Tecnologia & Ferramentas
              <ArrowRight size={14} />
            </Link>
          </div>
        </div>

        {/* ── Secção 2: Consultoria de IA ── */}
        <div className="mb-16">
          <div className="mb-10">
            <SectionBadge label="Consultoria de IA" />
            <h2 className="text-3xl font-bold text-foreground mb-3">
          ...
          <div className="mt-8 flex justify-end">
            <Link
              to="/produtos/consultoria-ia"
              className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-devin-teal transition-colors"
            >
              Ver preços e serviços de Consultoria de IA
              <ArrowRight size={14} />
            </Link>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-devin-teal text-background text-sm font-semibold hover:bg-devin-teal/90 transition-colors hover:scale-105 active:scale-95"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full border border-devin-border text-foreground text-sm font-medium hover:border-green-400/50 hover:text-green-400 transition-colors"
            >
